    ...
    <div class="div-centre">
        <div style="width: 100%">
            <div class="textInfo">
                ...
                <p>L'IUT de Béziers propose deux parcours : <stong>Création Numérique</stong> et <stong>Développement Web</stong>. Découvrez ce que vous allez apprendre avec nous !</p>
                <div id="conteneurParcours">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="home-tab" data-bs-toggle="tab"
                                data-bs-target="#home-tab-pane" type="button" role="tab" aria-controls="home-tab-pane"
                                aria-selected="true"><p class="tabBig">Parcours Création Numérique</p> <p class="tabSmall">Créa</p></button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="profile-tab" data-bs-toggle="tab"
                                data-bs-target="#profile-tab-pane" type="button" role="tab"
                                aria-controls="profile-tab-pane" aria-selected="false"><p class="tabBig">Parcours Développement
                                web</p> <p class="tabSmall">Dev</p></button>
                        </li>
                    </ul>
