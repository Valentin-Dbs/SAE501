                ...
                < </button>
                    <div class="carousel-container">
                        <div class="carousel-slide">
                            ...
                            <p>Comme le BUT MMI permet d'acquérir énormément de compétences différentes, il permet aussi
                                de travailler dans toutes sortes de métiers et toutes sortes de domaines.
                            </p>
                            <p>Pour les créatifs amoureux des graphismes ou de l’audiovisuel, il est tout à fait
                                possible de travailler dans une agence publicitaire ou de communication.</p>
                            <p> Pour les acharnés du code, votre avenir pourrait se dessiner dans le développement web,
                                la programmation d’applications, ou même la sécurité informatique.</p>



                            <p>Pour les maîtres de la communication, une carrière pourrait se profiler dans le
                                marketing, la stratégie de communication, la gestion des médias sociaux.</p>

                            <p>C’est une formation très polyvalente qui permet d’accéder à beaucoup de compétences, il
                                y a donc une plus grande liberté et diversité de choix que ce soit dans les études
                                supérieurs ou la voix professionnels.</p>
                        ...
                        <div class="carousel-slide">
                            <img src="..\img\developpeur-informatique.jpeg" alt="Développeur informatique"
                                width="200px">
                        ...
                        <div class="carousel-slide">
                            ...
                            <p>
                                <b>Synonymes :</b> Concepteur/trice-réalisateur/trice multimédia <br>
                                <b>Métiers Associés :</b> Concepteur/trice de jeux vidéo <br>
                                <b>Secteurs professionnels :</b> Édition, librairie, bibliothèque, Informatique et
                                réseaux,
                                Journalisme, Marketing , publicité <br>
                                <b>Centres d'intérêt : </b> Je me passionne pour les nouvelles technologies, Je suis
                                accro au
                                numérique
                            </p>
                        ...
                        <div class="carousel-slide">
                            ...
                            <p>
                                ...
                                Commerce et distribution, publicité, librairie,...) <br>
